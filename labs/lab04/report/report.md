...
header-includes:
  ...
  - \setlength{\parindent}{1.25cm} # 1.25 cm отступ в начале абзацев
  - \renewcommand{\baselinestretch}{1.5} # %1,5интервал
  - \renewcommand{\thechapter}{\arabic{chapter}} # для нумерации глав
## Layout adjustments
...
exec xgraph -bg lightblue -bb -tk -x time -t "TCPRenoCWND" WindowVsTimeRenoOne &
exec xgraph -bg lightblue -bb -tk -x time -t "TCPRenoCWND" WindowVsTimeRenoAll &
